    ...
    return (
        <div className='w-[91%] xl:max-w-[1080px] mx-auto my-[96px] '>
            <div className='relative p-4 sm:p-16 text-center  w-full h-[560px] sm:h-[601px] xl:w-[870px] lg:h-[700px] rounded-[50px] bg-black-darkest mx-auto  pup-crd  ' >
                <h2 className=' f-f-sm text-3xl lg:text-[60px] pupysaletext mt-[7px] ' >PuppyLove  Presale is live</h2>
...
<img src={LogArtboard} className='z-9 w-[183px] md:w-[191px] md:h-[191px] lg:w-[349px] h-[183px] lg:h-[349px] absolute right-[8px] sm:right-[-42px] xl:right-[-175px] bottom-[-93px] ' />
          <img src={coinsign} className=' w-[132px] sm:w-[148px] h-auto sm:h-[148px] absolute top-[-50px] sm:top-[-62px] left-[-10px] sm:left-[18px]  lg:hidden  ' />
                ...
                <div className="flex justify-center z-100"><a href="https://www.pinksale.finance/launchpad/0xb57072dBF8410F256f29526112d020aB306c5d73?chain=ETH"> <button className="bg-[#F59332] text-white f-f-sm border rounded-full  h-[60px] md   border-[#F59332] px-[32px] text-center  my-[68px]">Join Presale</button></a> </div>
